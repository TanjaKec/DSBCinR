...
1) Try out data classification using the KNN algorithm using [Air Quality Data](https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/airquality.html)

AppliedPredictiveModeling::data(twoClassData)
